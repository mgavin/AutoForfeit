...
private:
      ...
      bool check_forfeit_matchtime(const char * comparator, const int & match_seconds);
      bool check_forfeit_my_goals(const char * comparator, const int & comp_goals);
      bool check_forfeit_other_goals(const char * comparator, const int & comp_goals);
      bool check_forfeit_diff_goals(const char * comparator, const int & comp_goals);
