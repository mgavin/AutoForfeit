...
private:
      ...
      static std::filesystem::path GetStorageFilePath(
...
public:
      ...
      /// <param name="storage_file_name">The file of the config file excluding the file
      /// extension</param>
      /// <param name="auto_write">Automatically write cvar value to persistent storage
      /// once changed</param> <param name="auto_load">Automatically load the cfg after
      /// 0.1s</param>
      explicit PersistentCVarStorage(
            BakkesMod::Plugin::BakkesModPlugin * plugin,
            const std::string &                  storage_file_name,
            bool                                 auto_write = false,
            bool                                 auto_load  = false);

      PersistentCVarStorage(const PersistentCVarStorage & other)                 = delete;
      PersistentCVarStorage(PersistentCVarStorage && other) noexcept             = delete;
      PersistentCVarStorage & operator=(const PersistentCVarStorage & other)     = delete;
      PersistentCVarStorage & operator=(PersistentCVarStorage && other) noexcept = delete;
      ~PersistentCVarStorage();
      ...
      /// <summary>
      /// Registers a cvar with bakkesmod in addition to adding it to the list of
      /// persistent cvars.
      /// </summary>
      ...
      CVarWrapper RegisterPersistentCVar(
